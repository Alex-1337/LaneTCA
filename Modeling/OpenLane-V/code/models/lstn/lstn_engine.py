...
class LSTNEngine(nn.Module):
    ...
    def match_propogate_one_frame(self, img=None, img_embs=None):
        ...
        if img_embs is None:
            ...
            curr_enc_embs = img_embs
        self.curr_enc_embs = curr_enc_embs
        self.curr_lsab_output = self.lstn.LSAB_forward(curr_enc_embs, self.long_term_memories, self.short_term_memories, None, pos_emb=self.pos_emb, size_2d=self.enc_size_2d)
